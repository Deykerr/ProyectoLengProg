 ...
 * @author LENOVO
 */
@WebServlet(name = "VehiculoController", urlPatterns = {"/admin/vehiculo/*"})
public class VehiculoController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (url == null || url.equals("/")) {
            ...
            System.out.println("Cargar pantalla inicial del módulo de vehiculo");
        } else {
            ...
            switch (accion) {
                case "buscar":
                    ...
                    break;
                case "crear":
                    System.out.println("Cargar formulario de creación de vehiculo");
                    break;
                case "editar":
                    Integer id = Integer.parseInt(url_en_partes[2]);
                    System.out.println("Cargar formulario de edición del vehiculo con el ID " + id);
                    break;
                default:
