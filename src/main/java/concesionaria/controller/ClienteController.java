 ...
 * @author LENOVO
 */
@WebServlet(name = "ClienteController", urlPatterns = {"/admin/cliente/*"})
public class ClienteController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (url == null || url.equals("/")) {
            ...
            System.out.println("Cargar pantalla inicial del módulo de cliente");
        } else {
            ...
            switch (accion) {
                case "buscar":
                    ...
                    break;
                case "crear":
                    System.out.println("Cargar formulario de creación de cliente");
                    break;
                case "editar":
                    Integer id = Integer.parseInt(url_en_partes[2]);
                    System.out.println("Cargar formulario de edición del cliente con el ID " + id);
                    break;
                default:
