 ...
 * @author LENOVO
 */
@WebServlet(name = "InventarioController", urlPatterns = {"/admin/inventario/*"})
public class InventarioController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (url == null || url.equals("/")) {
            ...
            System.out.println("Cargar pantalla inicial del módulo de inventatrio");
        } else {
            ...
            switch (accion) {
                case "buscar":
                    ...
                    break;
                case "crear":
                    System.out.println("Cargar formulario de creación de invenatrio");
                    break;
                case "editar":
                    Integer id = Integer.parseInt(url_en_partes[2]);
                    System.out.println("Cargar formulario de edición del inventario con el ID " + id);
                    break;
                default:
