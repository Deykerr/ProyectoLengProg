 ...
 * @author LENOVO
 */
@WebServlet(name = "ProveedorController", urlPatterns = {"/admin/proveedor/*"})
public class ProveedorController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (url == null || url.equals("/")) {
            ...
            System.out.println("Cargar pantalla inicial del módulo de proveedor");
        } else {
            ...
            switch (accion) {
                case "buscar":
                    ...
                    break;
                case "crear":
                    System.out.println("Cargar formulario de creación de proveedor");
                    break;
                case "editar":
                    Integer id = Integer.parseInt(url_en_partes[2]);
                    System.out.println("Cargar formulario de edición del proveedor con el ID " + id);
                    break;
                default:
